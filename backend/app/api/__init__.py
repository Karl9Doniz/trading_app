...
from .operation import api as operation_api
from .contract import api as contract_api
...
api.add_namespace(operation_api, path='/api/operations')
api.add_namespace(contract_api, path='/api/contracts')
